...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010503','0105','已付款订单','${pageContext.request.contextPath}/adminOrders/findAll?state=2','','mainFrame');
		d.add('010504','0105','已发货的订单','${pageContext.request.contextPath}/adminOrders/findAll?state=3','','mainFrame');
		d.add('010505','0105','已完成的订单','${pageContext.request.contextPath}/adminOrders/findAll?state=4','','mainFrame');
		document.write(d);
