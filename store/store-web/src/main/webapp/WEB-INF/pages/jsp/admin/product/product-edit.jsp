...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/adminProduct/update" method="post" enctype="multipart/form-data">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="pname" placeholder="商品名称" value="${product.pname}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="shop_price" placeholder="市场价格" value="${product.shop_price}">
                        </div>
                        <div class="col-md-2 title">商城价格</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="market_price"  placeholder="商城价格" value="${product.market_price}">
                        </div>
                        ...
                        <div class="col-md-8 data rowHeight2x">
                            <textarea class="form-control" rows="3" name="pdesc" placeholder="请输入...">${product.pdesc}</textarea>
                        </div>
