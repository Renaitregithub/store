                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-right">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/adminProduct/showAdd'" >新建</button>
                                </div>
                            </div>
                        </div>
                        <!--/.工具栏-->
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">商品图片</th>
                                <th class="sorting_asc sorting_asc_disabled">商品名称</th>
                                <th class="sorting_asc sorting_asc_disabled">商品价格</th>
                                <th class="sorting_asc sorting_asc_disabled">是否热门</th>
                                <th class="sorting_asc sorting_asc_disabled">上架</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <c:forEach items="${pageInfo.list}" var="p" varStatus="status">
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/adminProduct/pushUp/${p.pid}">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <c:if test="${pageInfo.pageNum!=pageInfo.firstPage}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/adminProduct/findAll" aria-label="Previous">首页</a>
                                </li>
                            ...
                            <c:forEach begin="1" end="${pageInfo.lastPage}" varStatus="status">
                                <c:if test="${pageInfo.pageNum==status.count}">
                                    <li class="disabled"><a href="${pageContext.request.contextPath}/adminProduct/findAll?page=${status.count}">${status.count}</a></li>
                                </c:if>
                                <c:if test="${pageInfo.pageNum!=status.count}">
                                    <li class=""><a href="${pageContext.request.contextPath}/adminProduct/findAll?page=${status.count}">${status.count}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${pageInfo.pageNum!=pageInfo.lastPage}">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/adminProduct/findAll?page=${pageInfo.lastPage}" aria-label="Next">尾页</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
