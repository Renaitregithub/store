					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach varStatus="status" items="${pageInfo.list}" var="product">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminProduct/pushUp/${product.pid}">
		...
		<div style="width:380px;margin: 50px auto 0;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:if test="${pageInfo.pageNum!=pageInfo.lastPage}">
					...
					<li><a href="${pageContext.request.contextPath}/adminProduct/findAll?page=${pageInfo.lastPage}">末页</a></li>
				</c:if>
			</ul>
