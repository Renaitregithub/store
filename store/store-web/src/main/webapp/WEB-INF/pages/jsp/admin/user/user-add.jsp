...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/adminUser/add" method="post" >
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="username" placeholder="输入用户名" value="">
                        </div>
                        <div class="col-md-2 title">密码</div>
                        <div class="col-md-4 data">
                            <input type="password" class="form-control" name="password" placeholder="输入用户密码" value="">
                        </div>

                        <div class="col-md-2 title">真实姓名</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name" placeholder="输入真实姓名" value="">
                        </div>
                        <div class="col-md-2 title">邮箱</div>
                        <div class="col-md-4 data">
                            <input type="email" class="form-control" name="email" placeholder="输入email" value="">
                        </div>

                        <div class="col-md-2 title">电话</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="telephone" placeholder="输入用户联系方式" value="">
                        </div>
