				...
				<div class="col-md-10">
                    ...
                    <c:forEach items="${hotList}" var="product">
                        <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                            ...
                            <p><a href="${pageContext.request.contextPath}/product/findById/${product.pid}" style='color:#666' title="${product.pname}">${fn:substring(product.pname,0,15)}...</a></p>
				...
				<div class="col-md-10">
                    ...
                    <c:forEach items="${newList}" var="product">
                        <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                            ...
                            <p><a href="${pageContext.request.contextPath}/product/findById/${product.pid}" title="${product.pname}" style='color:#666'>${fn:substring(product.pname,0,15)}...</a></p>
                            <p><font color="#E4393C" style="font-size:16px">&yen;${product.shop_price}</font></p>
                        </div>
                    </c:forEach>
				</div>
