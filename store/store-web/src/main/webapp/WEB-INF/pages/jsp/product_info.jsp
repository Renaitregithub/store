			...
			<div class="container">
				<div class="row">
					<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
						...
						<a href="${pageContext.request.contextPath}/">${product.category.cname}&nbsp;&nbsp;&gt;</a>
						<a>${product.pname}</a>
					</div>
					<form action="${pageContext.request.contextPath}/cart/addToCart" method="post" id="form1">
							...
							<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
								...
								<div style="margin:20px 0 10px 0;;text-align: center;">
									...
									<a href="javascript:void(0)">
										<input style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button" onclick="subForm()">
									</a> &nbsp;收藏商品</div>
							</div>
						</div>
					</div>
